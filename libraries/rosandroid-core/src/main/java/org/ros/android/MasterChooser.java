...
import org.ros.android.json.ConfigHandler;
import org.ros.android.json.ConfigProperties;
import org.ros.android.view.SetDelay;
...
public class MasterChooser extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String ROS_IP = ConfigHandler.getModuleName(ConfigProperties.ROS_IP);
    if(ROS_IP != null && !ROS_IP.isEmpty() ) {
      uriText.setText(ROS_IP);
    }

    Button okbutton = (Button) findViewById(R.id.master_chooser_ok);
