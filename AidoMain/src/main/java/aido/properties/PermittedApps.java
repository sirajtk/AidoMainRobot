...
public class PermittedApps {
    ...
    static {
       ...
       //aMap.put("com.example.archi.health","NA");
        ...
        //aMap.put("com.example.archi.health.Activity.Profile","NA");
    ...
    static {
        ...
        aMap.put("com.example.archi.health"," Report Something");
        aMap.put("com.rathore.newsweathertraffic","News Weather And Traffic");
       ...
       // aMap.put("com.rathore.aidovirtualwinemanagertable","NA ");
        ...
        aMap.put("com.example.anil.temperature","sensor");
