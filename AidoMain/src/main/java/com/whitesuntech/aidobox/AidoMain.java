...
public class AidoMain extends AppCompatActivity {
    ...
    void installPackages()
    {
        ...
        if(!installNextPackage())
        {
            CommonlyUsed.showMsg(this,"Nothing to do! All Packages have been installed successfully!");
        }
    ...
    boolean installNextPackage()
    {
        ...
        else
        {
                ...
                CommonlyUsed.showMsg(this,"All Packages have been installed successfully!");
