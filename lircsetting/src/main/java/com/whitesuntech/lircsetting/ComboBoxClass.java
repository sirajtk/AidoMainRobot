...
public class ComboBoxClass extends Spinner {
    ...
    public void setWhiteDesign()
	{
	    ...
	    BitmapDrawable bg = new BitmapDrawable(BitmapFactory.decodeResource(getResources(),android.R.drawable.arrow_down_float));
	...
	private ArrayAdapter<ImageTextComboItem> getNewSpinnerAdapter()
	{
		...
		Activity tempActivity = (Activity) _maincontext;
