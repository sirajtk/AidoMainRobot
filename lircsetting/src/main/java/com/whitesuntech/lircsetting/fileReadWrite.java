...
public class fileReadWrite {
    ...
    public static ListCustom readPasscodeFile(Context context, String filename) {
        ListCustom returnList = new ListCustom();
        try {
        	...
        	String item = "";
        	 ...
        	 //CommonlyUsed.showMsg(context, "no of elem=" + returnList.size());
        	 is.close();
        	 BR.close();
    ...
    static public ListCustom getAllDirectoryNamesWithin(String dirname)
    {
