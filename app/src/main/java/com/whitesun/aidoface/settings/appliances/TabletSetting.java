...
public class TabletSetting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tablet_setting);

        _maincontext = TabletSetting.this;

        _behaviorfile = SettingProperties.getPhoneSettingsFile();
    ...
    public void PostData() {
        ...
        final String TabletNickname = etTvNickname.getText().toString();
        final String TabletModalname = etTvModelname.getText().toString();
        final String TabletModalno = etTvModelno.getText().toString();
        String url = "http://10.10.10.1/Api.php?apicall=createtvsettings&name="+TabletNickname+"&modelname="+TabletModalname+"&modelno="+TabletModalno;
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("TabletNickName", TabletNickname);
                params.put("TabletModalName", TabletModalname);
                params.put("TabletModalNo", TabletModalno);
                return params;
            }
