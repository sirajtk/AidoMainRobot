...
public class TvSetting extends AppCompatActivity {

    Context _maincontext;
    String _behaviorfile = "";
    List<String> _names = new ArrayList<>();
//    String url = "http://192.168.0.11:8888/Api.php?apicall=createtvsettings&name=asd1&modelname=asd2&modelno=asd3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _maincontext = TvSetting.this;

        _behaviorfile = SettingProperties.getTvSettingsFile();
    ...
    public void PostData() {
        ...
        final String TvNickname = etTvNickname.getText().toString();
        final String TvModalname = etTvModelname.getText().toString();
        final String TvModalno = etTvModelno.getText().toString();
        //String url = "http://192.168.0.11:8888/Api.php?apicall=createtvsettings&name="+TvNickname+"&modelname="+TvModalname+"&modelno="+TvModalno;
        String url = "http://10.10.10.1/Api.php?apicall=createtvsettings&name="+TvNickname+"&modelname="+TvModalname+"&modelno="+TvModalno;
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.i("tvconnectionerror",error.toString());
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("TvNickName", TvNickname);


                params.put("TvModalName", TvModalname);
                params.put("TvModalNo", TvModalno);
                Log.i("tvsettingsdata",TvNickname+" "+TvModalname+" "+TvModalno);
                return params;
            }
