...
public class PhoneSeting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_seting);
        _maincontext = PhoneSeting.this;
    ...
    public void PostData() {
        ...
        final String PhoneNickname = etTvNickname.getText().toString();
        final String PhoneModalname = etTvModelname.getText().toString();
        final String PhoneModalno = etTvModelno.getText().toString();
        String url = "http://10.10.10.1/Api.php?apicall=createtvsettings&name="+PhoneNickname+"&modelname="+PhoneModalname+"&modelno="+PhoneModalno;
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("PhoneNickName", PhoneNickname);
                params.put("PhoneModalName", PhoneModalname);
                params.put("PhoneModalNo", PhoneModalno);
                return params;
            }
