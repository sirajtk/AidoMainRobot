...
public class HomeApplianceSetting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_appliance_setting);
        _maincontext = HomeApplianceSetting.this;

        _behaviorfile = SettingProperties.getHomeApplianceSettingsFile();

        setTitle("Home Applicance Settings");


        _names.add("Appliance:");
        _names.add("Model:");
        _names.add("No.:");
    ...
    public void PostData() {
        ...
        final String HANickname = etTvNickname.getText().toString();
        final String HAModalname = etTvModelname.getText().toString();
        final String HAModalno = etTvModelno.getText().toString();
        String url = "http://10.10.10.1/Api.php?apicall=createtvsettings&name="+HANickname+"&modelname="+HAModalname+"&modelno="+HAModalno;
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("HANickName", HANickname);
                params.put("HAModalName", HAModalname);
                params.put("HAModalNo", HAModalno);
                return params;
            }
