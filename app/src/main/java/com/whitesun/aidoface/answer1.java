...
public class answer1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _ttsaido = new BroadcastTTS(answer1.this);
...
//            sp = cursor1.getString(1);
            ...
            System.out.println("hey"+Integer.parseInt(cursor1.getString(2)));
...
//
        ...
        System.out.println("updated score from answer 1"+score);
        ContentValues cv = new ContentValues();
        cv.put("score", score);
        db1.update("questionNumber", cv, "rno="+1, null);
//        ContentValues cv = new ContentValues();
////        cv.put("qno",);
//        cv.put("score","0");
