...
public class Memory_game4 extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_game4);
        _ttsaido = new BroadcastTTS(Memory_game4.this);
...
//
        ...
        _ttsaido.speak("question number four");
        _ttsaido.speak(question);
