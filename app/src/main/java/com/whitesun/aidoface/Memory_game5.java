...
public class Memory_game5 extends AppCompatActivity {
    ...
    String question;
    int count = 0;
    static Memory_game5 memory_game5;


    @Override
    protected void onCreate (Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_memory_game5);
        memory_game5 = this;
        _ttsaido = new BroadcastTTS(Memory_game5.this);
...
//        _ttsaido.speak("Here is your question number five");
...
//                        finish();
        ...
        _ttsaido.speak("question number five");
        _ttsaido.speak(question);
...
//        db.update("questionNumber", cv, "rno="+1, null);
    ...
    public static Memory_game5 getInstance(){
        return   memory_game5;
    }
