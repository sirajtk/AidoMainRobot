...
public class Memory_game3 extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_game3);
        _ttsaido = new BroadcastTTS(Memory_game3.this);
...
//
        ...
        _ttsaido.speak("question number three");
        _ttsaido.speak(question);
