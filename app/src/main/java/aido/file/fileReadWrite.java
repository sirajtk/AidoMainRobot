...
public class fileReadWrite {
    ...
    public fileReadWrite(String filename, int mode_read0_write1)
    {
        ...
        System.out.println("file name 1" + string_nameoffile + "\n");
    }
    ...
    public fileReadWrite(String filename, int readAfterLineNo, int lastLineToBeRead,int mode_read0_write1)
    {
        ...
        System.out.println("file name 2" + string_nameoffile + "\n");
    }
	...
	public static boolean writeIntoFile1(String strToWrite, String fileName) {
