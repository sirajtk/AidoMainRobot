...
public class MetricSelector extends FrameLayout {
    ...
    void initContent(LayoutInflater inflater, Resources res, String packageName) {
        ...
        videoOverlay = content.findViewById(R.id.video_overlay);
        ...
        imageView = content.findViewById(R.id.grid_item_image_view);
        imageViewBeneath = content.findViewById(R.id.grid_item_image_view_beneath);
        imageView.setImageResource(picId);
        imageViewBeneath.setImageResource(picId);
        imageViewBeneath.setVisibility(GONE);

        videoHolder = content.findViewById(R.id.video_holder);
        backgroundLayout = content.findViewById(R.id.grid_item_background);

        gridItemTextView = content.findViewById(R.id.grid_item_text);
        gridItemTextView.setText(MetricsManager.getCapitalizedName(metric));


        itemSelectedOverLimitColor = Color.RED;
        itemNotSelectedColor = Color.BLUE;
