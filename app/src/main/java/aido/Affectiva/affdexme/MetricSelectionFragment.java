...
import static aido.Affectiva.affdexme.MainActivityAffectiva.NUM_METRICS_DISPLAYED;
...
public class MetricSelectionFragment extends Fragment implements View.OnClickListener {
    ...
    void initUI(View fragmentLayout) {
        gridLayout = fragmentLayout.findViewById(R.id.metric_chooser_gridlayout);
        metricChooserTextView = fragmentLayout.findViewById(R.id.metrics_chooser_textview);
        ...
        messageAtOrUnderLimitColor = Color.WHITE;
        messageOverLimitColor = Color.RED;
    }
