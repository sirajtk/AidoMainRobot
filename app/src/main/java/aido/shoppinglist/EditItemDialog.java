...
public class EditItemDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState){
		...
		if(getTargetRequestCode() == ShoppingListFragment.EDIT_ITEM){
			TextView t = v.findViewById(R.id.item_uom);
			t.setText(R.string.edit_item);
		}

		EditText description = v.findViewById(R.id.description_editText);
		...
		EditText quantity = v.findViewById(R.id.qty_editText);
		...
		final Spinner spinner = v.findViewById(R.id.unit_spinner);
		...
		spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
									   int pos, long arg3) {
				if(spinner.getItemAtPosition(pos).getClass().equals("".getClass())){
